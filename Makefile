...
STORAGE := ${HOME}/meteo-data-storage
MODULE_NAME := meteo-data
PACKAGE := meteo-data
PACKAGE_PREFIX := meteo-data
...
update-wind-data: ## Update_wind_data
...
query: ## Script called "query.sh"
	@echo "======================================================"
	@echo "that lists all time-stamps that the wind speed in"
	@echo "Jerusalem went above the 5 day moving average"
	@echo "in Jerusalem"
	@echo "======================================================"
